...
namespace Project2_29628784.Models
{
    public partial class Project_2Context : DbContext
    {
        public Project_2Context()
        {
        }

        public Project_2Context(DbContextOptions<Project_2Context> options)
            : base(options)
        {
        }
